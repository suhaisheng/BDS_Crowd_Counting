...
avg_loss = 0.01*avg_loss_1 + 100*avg_loss_2
...
"""
pretrained_model = "/data1/ShengGe/ZSQ/paddlepaddle/saved_models/fluid_iterative_crowd_counting_dot_bbox/train/epoch_000183/checkpoint_0/__model__/"
if pretrained_model:
    def if_exist(var):
        # print('loading')
        #print (var.name)
...
# #  load saved params
path = "/data1/ShengGe/ZSQ/paddlepaddle/saved_models/fluid_iterative_crowd_counting_dot_bbox_twostage/train/epoch_000099/"  # finetune
...
for pass_id in range(100,1000):
    for batch_id, data in enumerate(train_reader()):
        
        avg_loss_data_1, avg_loss_data_2, etmap_num_data_1, etmap_num_data_2, den_gt_num_data_1, den_gt_num_data_2 = exe.run(
            fluid.default_main_program(),
            feed=feeder.feed(data),
            fetch_list=[avg_loss_1, avg_loss_2, etmap_num_1, etmap_num_2, den_gt_num_1, den_gt_num_2])  # den_gt_num_1 = den_gt_num_2
            #fetch_list=[avg_loss, etmap_num, den_gt_num])  # den_gt_num_1 = den_gt_num_2
        if batch_id % 200 == 0:
            print('epoch: %05d  batch_id: %05d'%(pass_id, batch_id))
            print('avg_loss_1: %.7f avg_loss_2: %.7f  etmap_num_1: %.7f etmap_num_2:%.7f den_gt_num_1:%.7f den_gt_num_2: %.7f'%(0.01*avg_loss_data_1[0], 100*avg_loss_data_2[0], etmap_num_data_1[0],
